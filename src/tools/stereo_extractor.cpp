...
int main(int argc, char** argv)
{
  ...
  desc.add_options()
    ("ileft,L", po::value<std::string>(), "left image file")
    ("iright,R", po::value<std::string>(), "right image file")
    ("cleft,J", po::value<std::string>(), "calibration file of left camera")
    ("cright,K", po::value<std::string>(), "calibration file of right camera")
